@php
    ...
    try {
         $is_online_payment_enabled = BasicConfiguration::query()->where('config_key', '=', 'is_online_payment_enabled')->first()->config_value;
     }
     catch (Exception $e) {
                ...
                <div class="">
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        ...
                        @if($is_online_payment_enabled === "yes")
                            <li>
                                <input type="radio" id="online-payment" name="payment_provider" value="online-payment"
                                       class="hidden peer"
                                       checked>
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-semibold text-gray-900" id='shipping_charge'>
                                {{ $product->is_shipping_charge_applicable ? 'will be calculated' : 'Free Delivery' }}</p>
                        </div>
                    </div>
                    <div class="mt-6 flex items-center justify-between">
                        <p class="text-sm font-medium text-gray-900">Total</p>
                        <p class="text-2xl font-semibold text-gray-900" id='total'>
                            {{ $product->is_shipping_charge_applicable ? 'will be calculated' : $product->sale_price }}</p>
                    </div>
                </div>
                <button type="submit"
