...
<header>
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="gap-x-12 flex">
            <a href="#" class="text-sm font-semibold leading-6">Sunglasses</a>
            <a href="#" class="text-sm font-semibold leading-6">Eyewear</a>
            <a href="#" class="text-sm font-semibold leading-6">Combo Package</a>
        </div>
    </nav>
</header>
